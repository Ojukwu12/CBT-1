...
const env = {
  ...
  EMAIL_REQUEST_COOLDOWN_MINUTES: parseInt(process.env.EMAIL_REQUEST_COOLDOWN_MINUTES || '10', 10),
  DAILY_WELCOME_EMAIL_LIMIT: parseInt(process.env.DAILY_WELCOME_EMAIL_LIMIT || '10', 10),
  WELCOME_EMAIL_RANDOM_RATE: Number.parseFloat(process.env.WELCOME_EMAIL_RANDOM_RATE || '0.35'),
  ...
  REFRESH_TOKEN_ROTATION_GRACE_SECONDS: parseInt(process.env.REFRESH_TOKEN_ROTATION_GRACE_SECONDS || '10', 10),
    ...
    EMAIL_VERIFICATION_FRONTEND_PATH: process.env.EMAIL_VERIFICATION_FRONTEND_PATH || '/verify-email',
  ...
  PUSH_FCM_BATCH_SIZE: parseInt(process.env.PUSH_FCM_BATCH_SIZE || '500', 10),
  NOTIFICATIONS_DEFAULT_PAGE_SIZE: parseInt(process.env.NOTIFICATIONS_DEFAULT_PAGE_SIZE || '20', 10),
  NOTIFICATIONS_MAX_PAGE_SIZE: parseInt(process.env.NOTIFICATIONS_MAX_PAGE_SIZE || '100', 10),
